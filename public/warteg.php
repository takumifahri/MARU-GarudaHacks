...
<body>
        ...
        <div class="container-header flex justify-between w-[412px] h-[50px] py-1">
           <h1 class="logo lg:text-5xl text-3xl mx-5 font-bold">
            ...
            <div class="button-like-notif flex">
                ...
                <a href="warteg.html"><svg class="w-[20px] h-[45px] mx-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>heart</title><path d="M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z"/></svg></a>
    ...
    <main class="main-container w-[412px] px-8 overflow-auto">
        ...
        <!-- card baru -->
        <section id="Card-Warteg" class="w-[345px] h-[700px] mt-10 p-2   rounded-lg shadow-lg" style="background-color: #FEFCE7;">
            ...
            <div class="main-card-warteg w-[330px] h-[110px] p-2 my-4 flex">
                <img src="images/subsidi-bahari.jpg" alt="kharisma" class="w-[150px] h-[90px] mr-2">
                <div class="explanation-warteg">
                    <a href="#ibu-madura-berkah" class="text-xs font-semibold">Warung subsidi bahari</a>
                    <h6 class="opacity-35 text-xs font-semibold mt-[-5px]" style="font-size: 8px;">Jalan Haji Raya 24, Surabaya, Jawa Timur</h6>
                    <br>
                    <div class="flex justify-between">
                        <div class="flex">
